...
function ticList($data){ //funkcija za prikaz tabela, sa parametrom "result-a" u zavisnosti sta se izlistava
    ...
    while($res =  mysqli_fetch_assoc($data)){
       ...
       echo "<th scope='col' class='text-white text-center'>".$res['type_problem']."</th>";
       ...
       echo "<th scope='col' class='text-white text-center'><a href='admin_oneTic_select?ticID=".$res['tic_number']."'><button class='btn btn-sm btn-primary btn-select btn-main button-i'>Prikaži više</button></a></th>";
       echo "</tr>";
...
<a href="admin_main" class="btn btn-primary button-back btn-main button-p"><i class="bi bi-arrow-left-square"></i>  Nazad</a>
<br><br>

    <div class="card card-admin bg-secondary text-white">
            <h3 class="text-center h3f">TIKETI: <span class="text-warning font-weight-bold"><?php echo $_GET['type']. "</span> - " .$kategorija; ?></h3>
            <table class="table table-dark">
              <thead>
                <tr class="text-center">
                  ...
                  <th scope="col" class="text-primary">TIP PROBLEMA</th>
